          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                PopupMenuButton(
                  itemBuilder: (context) => [
                    const PopupMenuItem(value: 'check', child: Text("check")),
                    const PopupMenuItem(
                      value: 'delete',
                      child: Text(
                        "Delete",
                  ...
                  onSelected: (val) async {
                    if (val == 'check') {
                      AppDialog().loading();
                      final res = await di<AppRepositories>()
                          .checkDrugInteractions(prescription.id);
                      AppDialog().dismiss();
                      res.when(
                        success: (s) {
                          showDialog(
                              ...
                              return Dialog(
                                child: Column(
                                  children: [
                                    ...
                                    ...s.comparisonSteps.map(
                                      (c) => Column(
                                        children: [
                                          Row(
                                            children: [
                                              Text(c.ingredientA.toString()),
                                              Text(c.ingredientB.toString()),
                                              Text(
                                                c.interactionFound
                                                    ? 'yes'
                                                    : 'No',
