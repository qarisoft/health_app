...
class _PatientHomePageState extends State<PatientHomePage> {
  ...
  void _showAddDataDialog([BuildContext? c]) {
    showDialog(
      context: c ?? context,
      builder: (context) {
        return AlertDialog(
...
class MyPatientHomePage extends StatefulWidget {
  const MyPatientHomePage({super.key});

  @override
  State<MyPatientHomePage> createState() => _MyPatientHomePageState();
}

class _MyPatientHomePageState extends State<MyPatientHomePage> {
