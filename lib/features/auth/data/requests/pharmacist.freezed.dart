...
mixin _$PharmacistRegisterRequest {
 ...
 String get nationalId; String get password; String get confirmPassword; String get fullName; DateTime get dateOfBirth; String get phoneNumber; String get email; String get licenseNumber; String get pharmacyName;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PharmacistRegisterRequest&&(identical(other.nationalId, nationalId) || other.nationalId == nationalId)&&(identical(other.password, password) || other.password == password)&&(identical(other.confirmPassword, confirmPassword) || other.confirmPassword == confirmPassword)&&(identical(other.fullName, fullName) || other.fullName == fullName)&&(identical(other.dateOfBirth, dateOfBirth) || other.dateOfBirth == dateOfBirth)&&(identical(other.phoneNumber, phoneNumber) || other.phoneNumber == phoneNumber)&&(identical(other.email, email) || other.email == email)&&(identical(other.licenseNumber, licenseNumber) || other.licenseNumber == licenseNumber)&&(identical(other.pharmacyName, pharmacyName) || other.pharmacyName == pharmacyName));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,nationalId,password,confirmPassword,fullName,dateOfBirth,phoneNumber,email,licenseNumber,pharmacyName);

@override
String toString() {
  return 'PharmacistRegisterRequest(nationalId: $nationalId, password: $password, confirmPassword: $confirmPassword, fullName: $fullName, dateOfBirth: $dateOfBirth, phoneNumber: $phoneNumber, email: $email, licenseNumber: $licenseNumber, pharmacyName: $pharmacyName)';
}
...
@useResult
$Res call({
 String nationalId, String password, String confirmPassword, String fullName, DateTime dateOfBirth, String phoneNumber, String email, String licenseNumber, String pharmacyName
});
...
/// Create a copy of PharmacistRegisterRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? nationalId = null,Object? password = null,Object? confirmPassword = null,Object? fullName = null,Object? dateOfBirth = null,Object? phoneNumber = null,Object? email = null,Object? licenseNumber = null,Object? pharmacyName = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String nationalId,  String password,  String confirmPassword,  String fullName,  DateTime dateOfBirth,  String phoneNumber,  String email,  String licenseNumber,  String pharmacyName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PharmacistRegisterRequest() when $default != null:
return $default(_that.nationalId,_that.password,_that.confirmPassword,_that.fullName,_that.dateOfBirth,_that.phoneNumber,_that.email,_that.licenseNumber,_that.pharmacyName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String nationalId,  String password,  String confirmPassword,  String fullName,  DateTime dateOfBirth,  String phoneNumber,  String email,  String licenseNumber,  String pharmacyName)  $default,) {final _that = this;
switch (_that) {
case _PharmacistRegisterRequest():
return $default(_that.nationalId,_that.password,_that.confirmPassword,_that.fullName,_that.dateOfBirth,_that.phoneNumber,_that.email,_that.licenseNumber,_that.pharmacyName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String nationalId,  String password,  String confirmPassword,  String fullName,  DateTime dateOfBirth,  String phoneNumber,  String email,  String licenseNumber,  String pharmacyName)?  $default,) {final _that = this;
switch (_that) {
case _PharmacistRegisterRequest() when $default != null:
return $default(_that.nationalId,_that.password,_that.confirmPassword,_that.fullName,_that.dateOfBirth,_that.phoneNumber,_that.email,_that.licenseNumber,_that.pharmacyName);case _:
  return null;
...
class _PharmacistRegisterRequest implements PharmacistRegisterRequest {
  const _PharmacistRegisterRequest({required this.nationalId, required this.password, required this.confirmPassword, required this.fullName, required this.dateOfBirth, required this.phoneNumber, required this.email, required this.licenseNumber, required this.pharmacyName});
...
/// Create a copy of PharmacistRegisterRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? nationalId = null,Object? password = null,Object? confirmPassword = null,Object? fullName = null,Object? dateOfBirth = null,Object? phoneNumber = null,Object? email = null,Object? licenseNumber = null,Object? pharmacyName = null,}) {
